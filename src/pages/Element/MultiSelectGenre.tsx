...
import { getAllGenre, getMovieDetails } from '../../function/ApiFunction';
...
const MultiSelectGenre: React.FC<DropdownProps> = ({ id, movieID, onSelectGenre }) => {
    ...
    return (
        <div className="relative z-50">
            <label className="mb-3 block text-black dark:text-white">
                Thể loại: {
                    genresMovie.length > 0 && genresMovie.map((item, index) => {
                        return (
                            <>
                                <p
                                    key={index}
                ...
                <select className="hidden" id={id}>
                    {
                        genres && genres.map((item, index) => {
                            return (
                                <option key={index} value={item.genre_vie}>{item.genre_vie}</option>
                            )
                        })
                    }
